sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.versionHackie.controller.Page5", {
			...
			if (status) {
				...
				return new Promise(function(fnResolve, fnReject) {
					...
					if (bHasPendingChanges) {
						...
						var oNewEntityInstance = Utilities.getDefaultValuesForPage6();
						oNewEntityInstance["___FK_275fd637b8d4d7d8157b121a_00042"] = oSourceBindingContext.getProperty("ID");

						oModel = this.getView().getModel();
						var oNewBindingContext = oModel.createEntry("accionSet", {
							properties: oNewEntityInstance
						});

						this.doNavigate("Page6", oNewBindingContext, fnResolve);
					}
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "Fiori_ObjectPage_ObjectPage_0-sections-Fiori_ObjectPage_Section-1-sectionContent-Fiori_ObjectPage_Table-1620856905860",
				"groups": ["items"]
			}];
