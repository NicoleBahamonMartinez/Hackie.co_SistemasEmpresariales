sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.versionCliente.controller.Page1", {
		...
		_onObjectListItemPress: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("Page3", oBindingContext, fnResolve, "", 0);
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
		...
		createFiltersAndSorters: function() {
			...
			aPropertyFilters.push(new sap.ui.model.Filter("nombre", "EQ", "Frioes"));
