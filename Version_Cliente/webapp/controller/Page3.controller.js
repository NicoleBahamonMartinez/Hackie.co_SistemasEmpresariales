sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.versionCliente.controller.Page3", {
		handleRouteMatched: function(oEvent) {
			...
			if (sContext) {
				...
				var oPath = {
					path: "/" + sContext,
					parameters: {
						"expand": "contrato_cliente,cositas_varias"
					}
				};
		...
		_onFeedInputPost: function() {
			return new Promise(function(fnResolve) {
				...
				sap.m.MessageToast.show("Gracias por tu retroalimentación!", {
					onClose: fnResolve,
					duration: 5000 || 3000,
					at: sTargetPos,
					my: sTargetPos
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "sap_Responsive_Page_0-content-sap_m_Panel-1622689005555-content-sap_m_StandardList-1622689053852",
				"groups": ["items"]
			}];
